...
cut :: [Int] -> [[Int]]
cut n = [take (length / 2) n, drop (length / 2) n]
...
//droptake2 :: [Int] -> [Int]
//droptake2 n 
//|length n > 3 = (take 2 (n)) ++ (drop ((length n)-2) n)
//= []
...
//del_firstlast [] = []
//del_firstlast [x:xs] = take ((length y) - 1) y
//where y = drop 2 [x:xs]
...
//lasts :: [[Int]] -> [Int]
//lasts [] = []
//lasts [x:xs] = [x!!((length x) - 1): lasts xs]
